...
<a href="add_edu.php" class="add-btn">+ Add New</a>
...
<table>
    ...
    <tr>
        ...
        <td><?= $row['Eduyear'] ?></td>
        <td>
            <a href="edit_edu.php?id=<?= $row['Id'] ?>">Edit</a> | 
            <a href="delete_edu.php?id=<?= $row['Id'] ?>" onclick="return confirm('Delete this?')">Delete</a>
        </td>
    </tr>
    <?php endwhile; ?>
